...
<html xmlns="http://www.w3.org/1999/xhtml"<?php if(isset($addbg)) { ?> class="addbg"<?php } ?>>
    ...
    <div class="subnav">
        <div class="content-menu ib-a blue line-x">
            <a class="on" href="<?php echo U('NewsCategory/index'); ?>"><em>管理类别</em></a>
            <span>|</span>
            <a href="<?php echo U('NewsCategory/add'); ?>"><em>添加类别</em></a>
        </div>
    </div>
    <!-- list begin -->
    <div class="pad_10">
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <?php if (is_array($list) && !empty($list)) { ?>
                        ...
                        <tr>
                            ...
                            <td><?php if (!empty($item['pic'])) { ?><img src="<?php echo $item['pic']; ?>" width="80" height="40"><?php } ?></td>
                            ...
                            <td>
                                <a href="<?php echo U('NewsCategory/update', array('id' => $item['id'])); ?>">更新</a>
                                <a href="javascript:confirmUrl('<?php echo U('NewsCategory/delete', array('id' => $item['id'])); ?>', '确定要删除吗？删除后就不能恢复啦！')">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                    <?php } else { ?>
        ...
        <div class="bk15"></div>
        <div class="btn">
            <input type="button" class="button" onClick="myform.action='<?php echo U('NewsCategory/sort');?>'; myform.submit();" value="排序"/>
        </div>
    </div> 
    <!-- list over -->
</body>

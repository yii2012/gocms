    ...
    <body>
        ...
        <div class="subnav">
            <div class="content-menu ib-a blue line-x">
                ...
                <span>|</span>
                <a class="on" href="<?php echo U('NewsCategory/add'); ?>"><em>添加类别</em></a>
            </div>
        </div>
        <div class="pad_10">
            <div class="common-form">
                <form name="myform" id="myform" action="<?php echo U('NewsCategory/add'); ?>" method="post">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            <tr>
                                <th style="width:140px;"><span class="required">*</span> 类别名称：</th>
                                <td><input type="text" class="input-text" name="NewsCategory[name]" style="width:250px;"></td>
                            </tr>
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="NewsCategory[description]" style="width:700px; height:60px;"></textarea></td>
                            </tr>
                            <tr>
                                <th>图片：</th>
                                <td>
                                    <input type="text" class="input-text" id="J_UploadBannerPic" name="NewsCategory[pic]" style="width:250px;">
                            ...
                            <tr>
                                <th>是否推荐：</th>
                                <td>
                                    <input type="checkbox" value="1" name="NewsCategory[is_rec]" />
                                </td>
                            </tr>
                        </tbody>
                    </table>

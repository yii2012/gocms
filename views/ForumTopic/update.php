    ...
    <body>
        ...
        <div class="subnav">
            <div class="content-menu ib-a blue line-x">
                ...
                <span>|</span>
                <a class="on" href="<?php echo U('ForumTopic/updae'); ?>"><em>更新类别</em></a>
            </div>
        </div>
        <div class="pad_10">
            <div class="common-form">
                <form name="myform" id="myform" action="<?php echo U('ForumTopic/update'); ?>" method="post" enctype="multipart/form-data">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            <tr>
                                <th style="width:140px;">类别名称：</th>
                                <td><input type="text" class="input-text" name="ForumTopic[name]" value="<?php echo $category_info['name']; ?>" style="width:250px;"></td>
                            </tr>
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="ForumTopic[description]" style="width:700px; height:60px;"><?php echo $category_info['description']; ?></textarea></td>
                            </tr>
                        </tbody>
                    </table>
                    <input type="hidden" name="ForumTopic[id]" value="<?php echo $category_info['id']; ?>">

    ...
    <body>
        ...
        <div class="subnav">
            <div class="content-menu ib-a blue line-x">
                ...
                <span>|</span>
                <a class="on" href="javascript:void(0);"><em>更新管理员</em></a>
            </div>
        </div>
        <div class="pad_10">
            <div class="common-form">
                <form name="myform" id="myform" action="<?php echo U("Admin/update"); ?>" method="post">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th>密码：</th>
                                <td>
                                    <input type="password" name="Admin[admin_password]" id="admin_password" autocomplete="off" class="input-text">
                                    不修改请留空
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>真实姓名：</th>
                                <td><input type="text" name="Admin[true_name]" id="true_name" value="<?php echo $admin_info['true_name']; ?>" class="input-text"></td>
                            </tr>
                        </tbody>
                    </table>
                    <input type="hidden" name="Admin[id]" value="<?php echo $admin_info['id']; ?>">

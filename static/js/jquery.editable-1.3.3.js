...
$.fn.editable = function(options){
	var defaults = {
		onEdit: null,
		onSubmit: null, //当鼠标单击可编辑区域以外的地方时，将数据提交到服务器的ajax函数
		onCancel: null,
		editClass: null, //type定义的表单的所采用的样式
		submit: null,
		cancel: null,
		type: 'text', //text, textarea or select （双击后可编辑区域变成哪种表单，例如textarea、input、select等。）
		submitBy: 'blur', //blur,change,dblclick,click
		editBy: 'click', //触发事件，例如双机、单击等
		options: null
	}
	if(options=='disable')
